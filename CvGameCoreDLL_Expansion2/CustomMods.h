...
#define MOD_TRAIT_COMBAT_BONUS_FROM_CAPTURED_HOLY_CITY gCustomMods.isTRAIT_COMBAT_BONUS_FROM_CAPTURED_HOLY_CITY()
...
public:
	...
	MOD_OPT_DECL(TRAIT_COMBAT_BONUS_FROM_CAPTURED_HOLY_CITY);
